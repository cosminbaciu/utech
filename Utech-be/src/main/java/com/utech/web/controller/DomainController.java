...
public class DomainController {
    ...
    public ResponseEntity<List<Domain>> getDomainsByCategory(@PathVariable Long id){
        return new ResponseEntity<>(domainRepository.findAllByCategoryId(id), HttpStatus.OK);
    }
